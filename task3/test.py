...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='/root/autodl-tmp/dataset/Synapse/test_vol_h5')
    ...
    parser.add_argument('--ckpt', type=str, default='SAM_ckpt/sam_vit_b_01ec64.pth',
                        help='Pretrained checkpoint')
    
    # test without grid points(lora)
    parser.add_argument('--lora_ckpt', type=str, default='ckpt/results1/Synapse_512_pretrain_vit_b_epo200_bs12_lr0.005/epoch_159.pth', help='The checkpoint from LoRA')
    
    # test with grid points(lora)
    # parser.add_argument('--lora_ckpt', type=str, default='ckpt/results2/Synapse_512_pretrain_vit_b_epo200_bs12_lr0.005/epoch_59.pth', help='The checkpoint from LoRA')
    
    # test without grid points(without lora)
    # parser.add_argument('--lora_ckpt', type=str, default='ckpt/results3/Synapse_512_pretrain_vit_b_epo100_bs12_lr0.005/epoch_67.pth', help='The checkpoint from LoRA')
